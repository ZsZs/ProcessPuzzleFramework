/*
Name: 
    - UnidirectionalSynchronizationProvider 
...
public class UnidirectionalSynchronizationProvider extends SynchronizationProvider {

   public UnidirectionalSynchronizationProvider( String name, HierarchicalConfiguration configuration, List<Class<?>> persistentClasses,
   ...
   @Override public void update( UnitOfWork work, Class<? extends PersistentObject> entityClass, PersistentObject entitiy ) {}
}
