...
<head>
	...
	<link rel="stylesheet" href="../../${skinDescriptor.stylesPath}/ViewSelector.css">
	...
	<script language="javascript" src="../JavaScript/TabWidget/InvertedTabWidget.js" ></script>
	...
	<script type="text/javascript">
		var docManViewSelector;
		
		function setUp(){
			docManViewSelector = new TabWidget(document.getElementById("InvertedTabWidget"));
			docManViewSelector.show();
		}
	</script>
</head>
