...
<br>
	...
	<form name="filterForm" onsubmit="return validateMethod" method="post" action="${artifactView.codeBase}">
		...
		<input name="forward" type="hidden" value="PurchaseOrderList_ListView">
...
<!--  -->
		...
		<div id="custom" class="editableContainer" style="display: none">
			<div class="row">
				...
				<span class="formw"><input type="text" id="orderIdEdit" value="${artifactView.orderId}" name="orderId"></span>
			</div>
			...
			<div class="row">
				...
				<span class="formw"><input type="text" id="purchaserEdit" value="${artifactView.purchaser}" name="purchaser"></span>
			</div>
			...
			<div class="row">
				...
				<span class="formw"><input type="text" id="contactPersonEdit" value="${artifactView.contactPerson}" name="contactPerson"></span>
			</div>
