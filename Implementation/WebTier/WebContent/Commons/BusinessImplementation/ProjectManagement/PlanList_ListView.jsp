...
<body onload="init();">
	...
	<div class="readOnlyContainer">
		<table style="width: 700px;" class="sortable" id="workflowListTable">
			<thead>
				<tr>
					<th></th>
			...
			<tbody>
				<c:forEach var="artifactProperty" items="${artifactView.listedArtifactsPropertyViews}" varStatus="index">
					<c:set var="classNameForRow" value="odd"/>
						...
						<td><input type="radio" name="plan" onclick="refreshPropertyInfo('${artifactProperty.id}', 'PlanDataSheet_PropertyView'); fillParameters('${artifactProperty.actionName}','${artifactProperty.id}'); enableButtons();"></td>
