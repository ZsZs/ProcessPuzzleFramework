// RestoreDatabaseManageCommand.js

function RestoreDatabaseManageCommand() {
	...
	function _Execute() {
		...
		{
			webUIController.loadDocument(null, "restoreName", "./CommandControllerServlet?action=ShowDatabaseAdmin");
		}
	}
}