	...
	*/
	...
	if (browser.dom || browser.ie4){
		...
		document.writeln('#CalendarContainer {');
		...
		document.writeln('background-color : #a9a9a9');
		document.writeln('}');
		document.writeln('</style>')
	...
	function Calendar(){
	  ...
	  if (browser.dom || browser.ie4){
		var tmpLayer = browser.dom?document.getElementById('CalendarContainer'):document.all.container;
	  }
