 		...
 		<fo:flow flow-name="xsl-region-body">
 			...
 			<fo:table>
				...
				<fo:table-header>
				  <fo:table-row>
				  	<fo:table-cell>
				      <fo:block font-weight="bold" font-size="12pt" font-family="tahoma">Cégnév</fo:block>
				    </fo:table-cell>
				    <fo:table-cell>
				...
				<fo:table-body>
 				<xsl:for-each select="propertyview">
	 				<fo:table-row>
	 				<fo:table-cell>
				      <fo:block font-family="Verdana" font-size="10pt"><xsl:value-of select="companyName"></xsl:value-of></fo:block>
				    </fo:table-cell>
				    <fo:table-cell>
